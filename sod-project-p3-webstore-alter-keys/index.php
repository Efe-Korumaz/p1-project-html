...
<body>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">Welkom op AlterKeys!</h1>
  ...
  <section class="about">
    <h2>Keyboards</h2>
    <br>
    <p>Discover our ultra aesthetic, customizable keyboards. With every detail designed in-house, we ensure premium
      materials, lasting designs, and a speedglide surface for faster actuations.</p>
    <br>
    <h2>Keycaps</h2>
    <p>Transform your keyboard setup with our 2x PBT Keycaps, offering superior durability and personalization options.
      Design your keycaps and express your style.</p>
  </section>
