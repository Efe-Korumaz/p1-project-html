...
<header>
  ...
  <section class="about">
    <h2>De geschiedenis van AlterKeys</h2>
    <br>
    <p>In het jaar 1969 had de heer Maximiliaan Bosarus Smith Korumaz 't Wout II een vraag aan zichzelf gesteld: "Hoe
      kunnen we toetsenborden van hoge kwaliteit betaalbaar maken voor de massa?".
      Hij dacht talloze jaren heel hard na over deze ene vraag, en nu, in 2024 heeft zijn kleinzoon Max Ferdinand
      Cornelius Bos een concreet antwoord op die vraag: AlterKeys.</p>
    </p>
    <br>
  </section>
