...
<header>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">Levering en Retour</h1>
  ...
  <section class="about">
    <h2>Levering</h2>
    <br>
    <p>De levering van uw product is als volgt:
      Binnen Nederland: 2-3 werkdagen
      Buiten Nederland maar binnen Europa: 3-5 werkdagen
      Buiten Europa: 7-10 werkdagen
    </p>
    <br>
    <h2>Retour</h2>
    <p>Niet tevreden met uw product? u krijgt bij aankoop van een product 30 dagen retourgarantie. Moet verpakt in een
      doos zitten met bon</p>
  </section>
