...
<header>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">Eco vriendelijk</h1>
  ...
  <section class=" about">
    ...
    <p>AlterKeys is een vooruitstrevende webshop die zich inzet voor milieuvriendelijke praktijken in de
      toetsenbordindustrie. Door zorgvuldige materiaalkeuze geven ze voorrang aan duurzame alternatieven zoals bamboe en
      gerecycled plastic. Ze implementeren milieubewuste operaties, van energiezuinige magazijnen tot minimaal
      verpakkingsmateriaal. Door samen te werken met milieuorganisaties doneren ze winst aan herbebossings- en
      natuurbeschermingsprojecten. Door gemeenschapsbetrokkenheid en educatieve initiatieven inspireert AlterKeys
      klanten om milieubewuste keuzes te maken, en bewijst dat winstgevendheid en duurzaamheid harmonieus kunnen
      samengaan in het bedrijfsleven.
    <p>
  </section>
