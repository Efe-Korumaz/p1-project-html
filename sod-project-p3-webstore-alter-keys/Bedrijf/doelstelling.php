...
<body>
  ...
  <section class="bg-asset">
    ...
    <h1 class="title">Doelstelling</h1>
  ...
  <section class="about">
    <h2>De doelstelling van ons bedrijf</h2>
    <br>
    <p>Het doel van AlterKeys is om premium, hoge kwaliteits toetsenborden en toetsenbord ascessoires te verkopen voor
